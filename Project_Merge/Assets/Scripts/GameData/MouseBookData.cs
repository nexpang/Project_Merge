...
public class MouseBookData : Singleton<MouseBookData>
{
    ...
    public void MouseBookDatatable()
    {
        ...
        MouseVo mouse01 = new MouseVo(1, "들쥐", $"이게 머쥐? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[0]:#,###}원", MouseSpriteManager.Instance.TileSprites[0].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse02 = new MouseVo(2, "햄스터", $"좀...귀엽쥐? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[1]:#,###}원", MouseSpriteManager.Instance.TileSprites[1].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse03 = new MouseVo(3, "다람쥐", $"다람쥐도 쥐 맞쥐? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[2]:#,###}원", MouseSpriteManager.Instance.TileSprites[2].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse04 = new MouseVo(4, "박쥐", $"박쥐는 포유류 맞쥐? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[3]:#,###}원", MouseSpriteManager.Instance.TileSprites[3].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse05 = new MouseVo(5, "더럽쥐", $"어디서 냄새가...우욱 \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[4]:#,###}원", MouseSpriteManager.Instance.TileSprites[4].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse06 = new MouseVo(6, "쥐포", $"구워먹으면 맛있을지도? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[5]:#,###}원", MouseSpriteManager.Instance.TileSprites[5].GetComponent<SpriteRenderer>().sprite);
        ...
        MouseVo mouse13 = new MouseVo(13, "스티븐 쥐압스", $"치즈가 제시하는 혁신적인 세상. \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[12]:#,###}원", MouseSpriteManager.Instance.TileSprites[12].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse14 = new MouseVo(14, "패션 잡쥐", $"쥐들의 패션을 설명하쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[13]:#,###}원", MouseSpriteManager.Instance.TileSprites[13].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse15 = new MouseVo(15, "쥐폐", $"펄-럭 \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[14]:#,###}원", MouseSpriteManager.Instance.TileSprites[14].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse16 = new MouseVo(16, "주쥐스님", $"깨달음을 얻고싶쥐... \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[15]:#,###}원", MouseSpriteManager.Instance.TileSprites[15].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse17 = new MouseVo(17, "번개쥐", $"ㅍ...번개쥐 백볼트! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[16]:#,###}원", MouseSpriteManager.Instance.TileSprites[16].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse18 = new MouseVo(18, "다리에 쥐", $"윽! 다리에 쥐가! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[17]:#,###}원", MouseSpriteManager.Instance.TileSprites[17].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse19 = new MouseVo(19, "스폰쥐", $"오늘의 실험! 물을 흡수해보쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[18]:#,###}원", MouseSpriteManager.Instance.TileSprites[18].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse20 = new MouseVo(20, "가쥐", $"가쥐는 어디로 가쥐? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[19]:#,###}원", MouseSpriteManager.Instance.TileSprites[19].GetComponent<SpriteRenderer>().sprite);

        MouseVo mouse21 = new MouseVo(21, "강아쥐", $"왈! ㅇ...찍? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[20]:#,###}원", MouseSpriteManager.Instance.TileSprites[20].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse22 = new MouseVo(22, "콩깍쥐", $"내눈...! 에 콩깍쥐. \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[21]:#,###}원", MouseSpriteManager.Instance.TileSprites[21].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse23 = new MouseVo(23, "오렌쥐", $"오렌쥐를 먹은지 얼마나 오렌쥐?\n잠깐! 먹지말쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[22]:#,###}원", MouseSpriteManager.Instance.TileSprites[22].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse24 = new MouseVo(24, "건전쥐", $"지치지 않쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[23]:#,###}원", MouseSpriteManager.Instance.TileSprites[23].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse25 = new MouseVo(25, "수도꼭쥐", $"콰아아ㅏㅏ아ㅏ \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[24]:#,###}원", MouseSpriteManager.Instance.TileSprites[24].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse26 = new MouseVo(26, "딱쥐", $"잠..잠깐 던지지 말쥐!! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[25]:#,###}원", MouseSpriteManager.Instance.TileSprites[25].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse27 = new MouseVo(27, "보석반쥐", $"사탕 같기도? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[26]:#,###}원", MouseSpriteManager.Instance.TileSprites[26].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse28 = new MouseVo(28, "미세먼쥐", $"내가 등장하면 마스크를 착용 하쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[27]:#,###}원", MouseSpriteManager.Instance.TileSprites[27].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse29 = new MouseVo(29, "휴쥐", $"이삿날 선물 뚝딱 \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[28]:#,###}원", MouseSpriteManager.Instance.TileSprites[28].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse30 = new MouseVo(30, "널빤쥐", $"밟지 말쥐! 찍! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[29]:#,###}원", MouseSpriteManager.Instance.TileSprites[29].GetComponent<SpriteRenderer>().sprite);

        MouseVo mouse31 = new MouseVo(31, "구쮜", $"플렉스- 하쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[30]:#,###}원", MouseSpriteManager.Instance.TileSprites[30].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse32 = new MouseVo(32, "쥐렁이", $"꿈-틀(밟힌듯 하다) \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[31]:#,###}원", MouseSpriteManager.Instance.TileSprites[31].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse33 = new MouseVo(33, "멧돼쥐", $"꾸이익? 찌찍? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[32]:#,###}원", MouseSpriteManager.Instance.TileSprites[32].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse34 = new MouseVo(34, "누룽쥐", $"뜨-끈하고 든-든한 누룽쥐탕 먹고싶쥐 \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[33]:#,###}원", MouseSpriteManager.Instance.TileSprites[33].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse35 = new MouseVo(35, "마이클 쥐액슨", $"나의 쥐-워크를 보쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[34]:#,###}원", MouseSpriteManager.Instance.TileSprites[34].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse36 = new MouseVo(36, "설거쥐", $"맑고 깨끗하고 자신있쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[35]:#,###}원", MouseSpriteManager.Instance.TileSprites[35].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse37 = new MouseVo(37, "아버쥐", $"생각만하면 눙물이 나쥐... \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[36]:#,###}원", MouseSpriteManager.Instance.TileSprites[36].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse38 = new MouseVo(38, "단무쥐", $"단무쥐의 뜻은 단순 무식 쥐! \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[37]:#,###}원", MouseSpriteManager.Instance.TileSprites[37].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse39 = new MouseVo(39, "황금쥐", $"오우 빛날줄 좀 아는 쥐인가? \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[38]:#,###}원", MouseSpriteManager.Instance.TileSprites[38].GetComponent<SpriteRenderer>().sprite);
        MouseVo mouse40 = new MouseVo(40, "십이간쥐", $"이 치즈가 식기 전에 고양이의 목에 방울을 달겠소 \n\n = 돈을 한번에 벌어오는 양 =\n{GameStat.Instance.MoneyDataTable[39]:#,###}원", MouseSpriteManager.Instance.TileSprites[39].GetComponent<SpriteRenderer>().sprite);
